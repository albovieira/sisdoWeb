...
CREATE TABLE `institution` (
  ...
  `user_id` int(11) NOT NULL,
  `picture` varchar(200) NOT NULL DEFAULT '/img/pictures/sem-imagem.jpg',
  PRIMARY KEY (`id`),
...
INSERT INTO `institution` VALUES (2,'Sao Joao','Instituicao Sao Joao','22222222222222','1','Uma instituicao legal',4,'/img/sem-imagem/sem-imagem-avatar.jpg'),(3,'Apae','Instituicao Apae','11111111111111','1','Apae uma instituicao que atua com crian̤as com defici̻ncia.',2,'/img/sem-imagem/sem-imagem-avatar.jpg');
...
CREATE TABLE `person` (
  ...
  `user_id` int(11) NOT NULL,
  `picture` varchar(200) NOT NULL DEFAULT '/img/sem-imagem/sem-imagem-avatar.jpg',
...
INSERT INTO `person` VALUES (1,'Albo Borges Vieira','M','1989-12-24',3,'/img/pictures/sem-imagem.jpg','mais sobre mim');
...
CREATE TABLE `rating` (
  ...
  `institution_user` int(11) NOT NULL,
  `rating` float NOT NULL,
  `person_user` int(11) NOT NULL,
  PRIMARY KEY (`id`,`id_transacao`)
...
INSERT INTO `transaction` VALUES (1,'2015-09-10 00:00:00','3','2015-09-14 00:32:54','2',1,2,3,'1',NULL),(2,'2015-09-10 00:00:00','4','0000-00-00 00:00:00','1',1,2,3,'1',NULL),(3,'2015-09-10 00:00:00','5','0000-00-00 00:00:00','1',2,2,3,'1',NULL);
...
-- Dump completed on 2015-09-16 23:48:37
